...
export function MobileNav({ onLinkClick }: MobileNavProps) {
  return (
    <div className="absolute left-0 top-full z-40 w-full animate-in fade-in-20 slide-in-from-top-4 bg-bg-light dark:bg-bg-dark lg:hidden transition-colors duration-300">
